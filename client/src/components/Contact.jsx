...
const Contact = () => {
  return (
    <div className='xl:w-[80vw] w-[95vw] mx-auto my-20 flex flex-col justify-center items-center'>
        <p className="md:text-4xl text-gray-700 text-2xl font-medium">Never Miss a Deal!</p>
        <p className="md:text-lg text-gray-500/80 pb-8 mt-2">Subscribe to get the latest offers, new arrivals, and exclusive discounts</p>
